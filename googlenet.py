...
X, Y = oxflower17.load_data('oxflower17/', one_hot=True, resize_pics=(227, 227))

network = input_data(shape=[None, 227, 227, 3])
conv1_7X7 = conv_2d(network, 64, 7, strides=2, activation='relu', name='conv1_7X7_S2')
pool1_3X3 = max_pool_2d(conv1_7X7, 3, strides=2)
pool1_3X3 = local_response_normalization(pool1_3X3)

conv2_3X3_reduce = conv_2d(pool1_3X3, 64, 1, activation='relu', name='conv2_3X3_reduce')
conv2_3X3 = conv_2d(conv2_3X3_reduce, 192, 3, activation='relu', name='conv2_3X3')
conv2_3X3 = local_response_normalization(conv2_3X3)
pool2_3X3 = max_pool_2d(conv2_3X3, kernel_size=3, strides=2, name='pool2_3X3_S2')

# 3a
inception_3a_1_1 = conv_2d(pool2_3X3, 64, 1, activation='relu', name='inception_3a_1_1')
inception_3a_3_3_reduce = conv_2d(pool2_3X3, 96, 1, activation='relu', name='inception_3a_3_3_reduce')
inception_3a_3_3 = conv_2d(inception_3a_3_3_reduce, 128, filter_size=3, activation='relu', name='inception_3a_3_3')
inception_3a_5_5_reduce = conv_2d(pool2_3X3, 16, filter_size=1, activation='relu', name='inception_3a_5_5_reduce')
inception_3a_5_5 = conv_2d(inception_3a_5_5_reduce, 32, filter_size=5, activation='relu', name='inception_3a_5_5')
inception_3a_pool = max_pool_2d(pool2_3X3, kernel_size=3, strides=1, name='inception_3a_pool')
